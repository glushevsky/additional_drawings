...
def main(scale, w, f, T, error, width, height, step, m_step):
    ...
    create_image(width, height, a1_line_points, scale, 'a12_' + name_part + '.png')
    ...
    # create_image(width, height, common_points, scale, 'common_' + name_part + '.png')
    # print('create img in ', datetime.datetime.now() - time_start)
...
if __name__ == "__main__":
    ...
    height = 500  # половина высоты картинки
    step = 0.0001  # шаг
